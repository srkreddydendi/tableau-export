$(document).ready(function() {
  initializeTableau();
    $('#export').click(function() {
        var selectedSheet = $("#dropdown").val();
        downloadDataFromSheet(sheetName);
    });
...
function downloadDataFromSheet(sheetName){
 const dashboard = tableau.extensions.dashboardContent.dashboard;
dashboard.worksheets.filter(worksheet => worksheet.name === sheetName).forEach(function(worksheet) {
